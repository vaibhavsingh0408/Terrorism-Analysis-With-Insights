...
def create_app_ui():
  ...
  html.H1('Terrorism Analysis with Insights', id='Main_title',
          style={'textAlign': 'center', 'color': '#006400', 'background-color': '#F5DEB3','font-size': '40px'}),
  dcc.Tabs(id="Tabs", value="Map",
           children=[
      dcc.Tab(label="Map tool" ,id="Map tool",value="Map",
              style={'fontWeight': 'bold', 'backgroundColor': '#F5DEB3', 'color': '	#006400'
                           },
              selected_style={'fontWeight': 'bold', 'backgroundColor': '#F5DEB3', 'color': '#000000'
                                     },
              children=[
          dcc.Tabs(id = "subtabs", value = "WorldMap",children = [
              dcc.Tab(label="World Map tool", id="World", value="WorldMap",selected_style={'fontWeight': 'bold', 'color': '#000000'
                                     }, style={'fontWeight': 'bold', 'color': '	#006400'}),
              dcc.Tab(label="India Map tool", id="India", value="IndiaMap",selected_style={'fontWeight': 'bold', 'color': '#000000'
                                     }, style={'fontWeight': 'bold', 'color': '	#006400'})
              ]),
          dcc.Dropdown(
              id='month',
          ...
          html.H5('Select the Year', id='year_title',
                  style={ 'textAlign': 'center', 'color': '#006400',
                                   'background-color': '#F5DEB3', 'font-size': '20px'}),
          dcc.RangeSlider(
                    id='year-slider',
                    min=min(year_list),
                    max=max(year_list),
      ...
      dcc.Tab(label = "Chart Tool", id="chart tool", value="Chart", style={'fontWeight': 'bold', 'backgroundColor': '#F5DEB3', 'color': '	#006400'
                           },selected_style={'fontWeight': 'bold', 'backgroundColor': '#F5DEB3', 'color': '#000000'
                                     },children=[
          dcc.Tabs(id = "subtabs2", value = "WorldChart",children = [
              dcc.Tab(label="World Chart tool", id="WorldC", value="WorldChart",selected_style={'fontWeight': 'bold', 'color': '#000000'
                                     }, style={'fontWeight': 'bold', 'color': '	#006400'}),
            dcc.Tab(label="India Chart tool", id="IndiaC", value="IndiaChart",selected_style={'fontWeight': 'bold', 'color': '#000000'
                                     }, style={'fontWeight': 'bold', 'color': '	#006400'})]),
            ...
            html.Br(),
            html.Hr(),
            dcc.Input(id="search", placeholder="Search Filter",style={'borderColor': 'orange','width': '30%'}),
            html.Hr(),
            html.Br(),
            dcc.RangeSlider(
                    id='cyear_slider',
  ...
  html.Div(dcc.Loading(id = "graph-object",type="circle", children ="Loading......"))
  ])
